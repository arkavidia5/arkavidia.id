            ...
            <v-flex sm12 xs10 md8>
                  ...
                  <v-layout row>
                    <v-flex class="d-flex flex-column">
                      ...
                      <v-layout row>
                        <a href="https://static.arkavidia.id/5/rulebook/Arkavidia5_CTF_Rulebook_v20181020.pdf" class="no-decoration" target="_blank">
            ...
            <v-flex sm12 xs12>
              ...
              <v-layout row>
                  <Timeline>
                    ...
                    <TimelineItem direction="right" image="https://static.arkavidia.id/5/images/icons/competition/icon_pengumuman.svg" title="PENGUMUMAN FINALIS" time="20 Januari 2018" description="Pengumuman finalis di media sosial Arkavidia 5.0"/> 
